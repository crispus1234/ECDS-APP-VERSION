...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialise
        //username = findViewById(R.id.nav_header_name_id);
...
//            @Override
//            public void run() {
//                FetchData fetchData = new FetchData("http://10.10.9.138/ECSADMIN/session.php");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()){
            case R.id.nav_home_id:
                getSupportFragmentManager().beginTransaction().replace(R.id.framelayout_id, new HomeActivity())
                        .commit();
                closeDrawer();
                break;
            ...
            case R.id.nav_profile_id:
                getSupportFragmentManager().beginTransaction().replace(R.id.framelayout_id, new com.course.eyecataractsap.ProfileFragment())
                        .commit();
                closeDrawer();
                break;
            case R.id.nav_upload_id:
                getSupportFragmentManager().beginTransaction().replace(R.id.framelayout_id,new UploadFragment())
                        .commit();
                closeDrawer();
                break;
            case R.id.nav_record_id:
                getSupportFragmentManager().beginTransaction().replace(R.id.framelayout_id,new TreatmentActivity())
                        .commit();
                closeDrawer();

                break;
//            case R.id.nav_information_id:
//                Toast.makeText(this, "Information Pressed", Toast.LENGTH_SHORT).show();
//                break;
...
//                Toast.makeText(this, "Photos Pressed", Toast.LENGTH_SHORT).show();
            ...
            case R.id.nav_settings_id:
                getSupportFragmentManager().beginTransaction().replace(R.id.framelayout_id, new com.course.eyecataractsap.SettingsFragment())
                        .commit();
